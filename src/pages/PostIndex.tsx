  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center max-w-2xl mx-auto mb-16">
        <h1 className="text-4xl md:text-5xl font-serif font-bold tracking-tight text-white mb-4">All Projects</h1>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 mb-12">
        <span className="text-gray-500 uppercase tracking-widest text-xs font-bold mr-2">Filter by Category:</span>
        {categories.map(cat => (
           <Link 
             key={cat} 
